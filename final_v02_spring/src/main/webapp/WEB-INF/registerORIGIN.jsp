	...
	<form action="registerProc" method="post">
		...
		<caption><fmt:message key="register.form"/></caption>
			...
			<tr>
				...
				<td><input type="text" name="full_name" maxlength="75" required /></td>
			</tr>
			<tr>
				<td><fmt:message key="register.user.type"/></td>
				<td><input type="text" name="user_type" value="${param.type}" readonly /></td>
			</tr>
			<tr>
				<td><fmt:message key="register.login"/></td>
				<td><input type="text" name="login" maxlength="20" required /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="email" maxlength="20" required /></td>
			</tr>
